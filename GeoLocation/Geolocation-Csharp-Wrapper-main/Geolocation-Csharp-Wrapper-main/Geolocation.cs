...
public partial class Geolocation : Node
{
    ...
    public Godot.GodotObject GeolocationPlugin = null;
    ...
    {
        get => Supported ? GeolocationPlugin.Call("authorization_status").As<GeolocationAuthorizationStatus>() :
    ...
    private void SetupNativePlugin()
    {
        ...
        if (Platform == Platforms.Android)
        {
            GetTree().Connect("on_request_permissions_result", new Callable(this,nameof(OnGodotPermissionAndroid)));
        }
        ...
        if (Engine.HasSingleton(pluginName))
        {
            ...
            GeolocationPlugin.Connect("error", new Callable(this, nameof(OnErrorSignal)));
            GeolocationPlugin.Connect("log", new Callable(this, nameof(OnLogSignal)));
            GeolocationPlugin.Connect("location_update", new Callable(this, nameof(OnLocationUpdate)));
            GeolocationPlugin.Connect("authorization_changed", new Callable(this, nameof(OnAuthorizationChanged)));
            GeolocationPlugin.Connect("heading_update", new Callable(this, nameof(OnHeadingUpdate)));
            GeolocationPlugin.Connect("location_capability_result", new Callable(this, nameof(OnLocationCapabilityResult)));
        }
    }
